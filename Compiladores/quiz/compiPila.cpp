...
int main()
{
    ...
    //PRIM Tp INVERTIDO
    insertaTP("Tp","ARITHOP","Tp F ARITHOP");
    //SIG Tp 
    //insertaTP("Tp","ARITHOP",  "ε"); Si ((tp = ε) => (Ep = arithop))
    ...
    //PRIM Ep INVERTIDO
    insertaTP("Ep","ARITHOP","Ep T ARITHOP"); 
    //SIG Ep
    ...
    insertaTP("S","ID",    "SEMICOLON B ASSIGN L");
