/*
    @title = Luz y materiales.
    @Description = 
    SpotLight empleando el modelo de las clases pasadas.
    - Spotlight
    - R. difusa
    @autor = arcatus
*/
...
int main()
{
    ...
    Vector3 s, cursor;
    Matrix4x4 AxisUp, AxisSide, view, projection;
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        glUniform1f(
            glGetUniformLocation(shaderProgram, "innerCutOff"), cos(12.5f / 180));

        glUniform1f(
            glGetUniformLocation(shaderProgram, "outerCutOff"), cos(17.5f / 180));

        glUniform3f(
            glGetUniformLocation(shaderProgram, "lightDirection"),
