...
int main()
{
    ...
    Matrix4x4 mvp, projection, model, view, rotationAxisSide, rotationAxisUp;
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(
            glGetUniformLocation(shaderProgram, "lightPosition"),0.0f,1.0f,0.0f);
...
GLuint createPlane(GLuint* vbo, GLuint* ebo)
{
    GLfloat vertices[] =
    {
        -3.0f,-0.51f, -3.0f,     0.0f, 0.0f, 1.0f, 1.0f,     0.0f, 1.0f, 0.0f,
        -3.0f,-0.51f,  3.0f,     0.0f, 0.0f, 1.0f, 1.0f,     0.0f, 1.0f, 0.0f,
         3.0f,-0.51f, -3.0f,     0.0f, 0.0f, 1.0f, 1.0f,     0.0f, 1.0f, 0.0f,
         3.0f,-0.51f,  3.0f,     0.0f, 0.0f, 1.0f, 1.0f,     0.0f, 1.0f, 0.0f,
    };
