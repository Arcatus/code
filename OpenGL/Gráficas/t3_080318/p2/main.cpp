...
GLuint createBezier(GLuint* vbo, GLuint* ebo, GLuint n);
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Curva de Bezier",NULL, NULL);
    ...
    GLuint vao, vbo, ebo, n = 30;
    vao = createBezier(&vbo, &ebo, n);
...
GLuint createBezier(GLuint* vbo, GLuint* ebo, GLuint n)
{
    ...
    for (GLfloat i = 0; i <= 1.0f; i +=inc)
    {
        ...
        Matrix4x4 tmp = Bt * parametrizacion;
