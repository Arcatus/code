...
void calcNormals
(GLuint* elements, GLuint numElements, GLfloat* vertices, GLuint numVertices, GLuint numComp); // ok

void Vector3InitToZero(Vector3* vector); //ok

void Vector3Normalize(Vector3* vector); //ok

Vector3 Vector3Normalize(const Vector3& vector); //ok

float Vector3ScalarProduct(Vector3* v1, Vector3* v2); //ok

void Vector3CrossProduct(Vector3* v1, Vector3* v2, Vector3* result); //ok

Vector3 Vector3CrossProduct(const Vector3& v1,const Vector3& v2); //ok
...
void Matrix4x4MakeView(Vector3* position, Vector3* target, Vector3* up, Matrix4x4* view); //ok
