/*
    ...
    @Description = 
    Ejemplo de tetaedro modelado con renderizado no indexado,
    empleando distintos tipos de luz-reflexión:
    - L. puntual
    - R. difusa
    - R. especular
    @autor = arcatus
...
int main()
{
    ...
    Vector3InitToZero(&oldDelta);
    Vector3InitToZero(&newDelta);
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(
            glGetUniformLocation(shaderProgram, "lightPosition"),0.0f,2.0f*sinf(elapsedTime),0.0f);
